    ...
    function closeImageModal() {
        ...
        <form id="updateForm" class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white p-4 sm:p-6 rounded-lg shadow-md w-full max-w-xs sm:max-w-lg md:max-w-2xl lg:max-w-4xl">
            ...
            <div class="col-span-full text-center">
                <button type="button" onclick="updateAlumno()" class="w-full bg-black text-white font-semibold py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400">Guardar Cambios</button>
            </div>
        </form>
    </div>

    <!-- Scripts de manejo de imagen y actualización -->
    <script type="module" src="../../js/perfilEstudiante.js"></script>
</body>
</html>
